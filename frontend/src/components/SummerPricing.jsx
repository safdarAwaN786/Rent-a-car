...
export default function SummerPricing() {
    ...
    return (
        <>
            {loading ? (
                ...
                <div className='p-3'>
                    <h3 className='text-center'>Summer Prices</h3>
                        ...
                        <div className='addProductBox justify-content-center pt-5  '>
                            <div className='formBox border-circle  mt-5 pt-4 '>
                                ...
                                <div data-aos="fade-down" className=' mb-3 myBox mx-auto border-circle p-3'>
                                    ...
                                    <h1 className='text-center fs-4'>Edit Summer Prices for : {groupToProcess.groupName}</h1>
                                    ...
                                    <form encType='multipart/form-data' onSubmit={(event) => {
                                        ...
                                        <div className='d-flex flex-column'>
                                            ...
                                            <div className='extraBox my-2 border-circle p-2 d-flex  justify-content-between'>
                                                ...
                                                <div><span>€</span>
                                                    <input value={groupToProcess.summerPrices['1to2daysPrice']} onChange={(e) => {

                                                        setGroupToProcess({
                                                            ...groupToProcess,
                                                            summerPrices: {
                                                                ...groupToProcess.summerPrices,
                                            ...
                                            <div className='extraBox my-2 border-circle p-2 d-flex  justify-content-between'>
                                                ...
                                                <div><span>€</span>
                                                    <input value={groupToProcess.summerPrices['3to6daysPrice']} onChange={(e) => {
                                            ...
                                            <div className='extraBox my-2 border-circle p-2 d-flex  justify-content-between'>
                                                ...
                                                <div><span>€</span>
                                                    <input value={groupToProcess.summerPrices['7to14daysPrice']} onChange={(e) => {
                                            ...
                                            <div className='extraBox my-2 border-circle p-2 d-flex  justify-content-between'>
                                                ...
                                                <div><span>€</span>
                                                    <input value={groupToProcess.summerPrices['15plusDaysPrice']} onChange={(e) => {
                                ...
                                {groups?.map((groupObj, index) => {
                                    return (
                                        <tr>
                                            ...
                                            <td scope="row">€<b>{groupObj.summerPrices['1to2daysPrice']}</b></td>
                                            <td scope="row">€<b>{groupObj.summerPrices['3to6daysPrice']}</b></td>
                                            <td scope="row">€<b>{groupObj.summerPrices['7to14daysPrice']}</b></td>
                                            <td scope="row">€<b>{groupObj.summerPrices['15plusDaysPrice']}</b></td>
