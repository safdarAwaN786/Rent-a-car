...
export default function SummerHighPricing() {
    ...
    return (
        <>
            {loading ? (
                ...
                <div className='p-3'>
                    <h3 className='text-center'>Summer High Prices</h3>
                        ...
                        <div className='addProductBox justify-content-center pt-5  '>
                            <div className='formBox border-circle  mt-5 pt-4 '>
                                ...
                                <div data-aos="fade-down" className=' mb-3 myBox mx-auto border-circle p-3'>
                                    ...
                                    <h1 className='text-center fs-4'>Edit Summer High Prices for : {groupToProcess.groupName}</h1>
                                    ...
                                    <form encType='multipart/form-data' onSubmit={(event) => {
                                        ...
                                        <div className='d-flex flex-column'>
                                            ...
                                            <div className='extraBox my-2 border-circle p-2 d-flex  justify-content-between'>
                                                ...
                                                <div><span>€</span>
                                                    <input value={groupToProcess.summerHighPrices['7to14daysPrice']} onChange={(e) => {
                                            ...
                                            <div className='extraBox my-2 border-circle p-2 d-flex  justify-content-between'>
                                                ...
                                                <div><span>€</span>
                                                    <input value={groupToProcess.summerHighPrices['15plusDaysPrice']} onChange={(e) => {
